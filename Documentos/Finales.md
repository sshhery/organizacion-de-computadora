```1)``` Dada la representación A185h (en bch) de un sistema en punto flotante con 8 bits de mantisa en bcs y bit implicito. Exp en 8 bit en exceso 128(en ése orden de izquierda a derecha) 
